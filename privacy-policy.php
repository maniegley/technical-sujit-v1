            ...
            <div class="row">
                <div class="col-sm-8">
	                ...
	                <div class="entry-content">
                        ...
                        <h1>Privacy Policy --- TechnicalSujit</h1>
                        <p>At TechnicalSujit, accessible from <a href="https://technicalsujit.in/">TechnicalSujit</a>, one of our main priorities is the privacy of our visitors. 
                            This Privacy Policy document contains types of information that is collected and recorded by TechnicalSujit and how we use it.
                        </p>
                        <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us<a href="contact-us.php">Contact Us</a>.</p>
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to 
                            our website with regards to the information that they shared and/or collect in TechnicalSujit. 
                        ...
                        <p>The personal information that you are asked to provide, and the reasons why you are asked 
                            ...
                            email address, phone number, the contents of your query and/or attachments you may send us, 
                            and any other information you may choose to provide.<br />When you register for an Account, 
                        ...
                        <ul>
                            ...
                            <li><br />Develop new products, services, features, and functionality</li>
                            <li>Communicate with you, either directly or through one of our partners, 
                                including for customer service, to provide you with updates and other information relating to the 
                                website, and for marketing and promotional purposes
                            </li>
                            <li>Send you emails</li>
                            <li><br />Find and prevent fraud</li>
                        </ul>
                        <h2>Log Files</h2>
                        <p>TechnicalSujit follows a standard procedure of using log files. These files log visitors when they 
                        ...
                        <p>Like any other website, TechnicalSujit uses cookies. These cookies are used to store information including 
                        ...
                        <h2>Google Double Click DART Cookie</h2>
                        <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, 
                            ...
                            URL <a> href="https://policies.google.com/technologies/ads"</a>
                        </p>
                        <h2><br />Advertising Partners Privacy Policies</h2>
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or 
                            ...
                            TechnicalSujit, which are sent directly to users&#8217; browser. They automatically receive your 
                        ...
                        <p>Note that TechnicalSujit has no access to or control over these cookies that are used by 
                            third-party advertisers.
                        </p>
                        <h2>Third Party Privacy Policies</h2>
                        <p>TechniclSujit's Privacy Policy does not apply to other advertisers or websites. Thus, we 
                        ...
                        and specific pieces of personal data that a business has collected about consumers.<br />
                        Request that a business delete any personal data about the consumer that a business has collected.
                        <br />Request that a business that sells a consumer's personal data, not sell the 
                        consumer's personal data.<br />If you make a request, we have one month to respond to you. 
                        If you would like to exercise any of these rights, please contact us.
                        </p>
                        <h2>GDPR Data Protection Rights</h2>
                        <p>We would like to make sure you are fully aware of all of your data protection rights. 
                            Every user is entitled to the following:<br />The right to access – You have the right 
                            to request copies of your personal data. We may charge you a small fee for this service.<br />
                            ...
                            information you believe is incomplete.<br />The right to erasure – You have the right to 
                            ...
                            processing of your personal data, under certain conditions.<br />The right to object to 
                            processing – You have the right to object to our processing of your personal data, under 
                            certain conditions.<br />The right to data portability – You have the right to request that 
                            we transfer the data that we have collected to another organization, or directly to you, 
                            under certain conditions.<br />If you make a request, we have one month to respond to you. 
                            If you would like to exercise any of these rights, please contact us.
                        </p>
                        ...
                        <p>TechnicalSujit does not knowingly collect any Personal Identifiable Information from 
